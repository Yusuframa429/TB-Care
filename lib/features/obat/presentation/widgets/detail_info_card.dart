...
class DetailInfoCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        children: [
          InfoRow(icon: Icons.repeat_rounded, iconColor: AppColors.primary, label: 'Frekuensi', value: frekuensi),
          const Divider(height: 20, color: AppColors.border),
          InfoRow(icon: Icons.restaurant_rounded, iconColor: AppColors.warning, label: 'Kondisi Makan', value: kondisiMakan),
        ],
      ),
    );
  }
